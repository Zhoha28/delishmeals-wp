...
vc_map( array(
  ...
  'params' => array(
    ...
    array(
      ...
      'param_name' => 'img_size',
      'description' => esc_html__('Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "full" image size.', 'goya-core')
    ),
    array(
		  'type' => 'textfield',
		  'heading' => esc_html__('Image sizes', 'goya-core'),
		  'param_name' => 'img_sizes',
		  'description' => esc_html__('Enter image sizes attribute for responsive image loading', 'goya-core')
		),
		array(
      'type'      => 'attach_image',
      'heading'     => __( 'Image - Tablet/Mobile', 'goya-core' ),
      'param_name'  => 'alt_image_id',
      'description'   => __( 'Set an optional banner image to display on smaller screens (max-width: 640px).', 'goya-core' )
    ),
    array(
      'type' => 'dropdown',
