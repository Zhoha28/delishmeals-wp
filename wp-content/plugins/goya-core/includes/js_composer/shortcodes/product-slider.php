<?php function goya_shortcode_product_slider( $atts, $content = null ) {
	...
	if ( $products->have_posts() ) {
		...
		$columns_mobile = apply_filters('et_product_slider_mobile_columns', get_theme_mod('shop_columns_mobile', 2) );
