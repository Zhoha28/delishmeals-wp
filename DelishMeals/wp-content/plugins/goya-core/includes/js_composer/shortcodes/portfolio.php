<?php function goya_shortcode_portfolio( $atts, $content = null ) {
  ...
  ?>
	<div class="<?php echo esc_attr(implode(' ', $classes)); ?>" data-loadmore="#loadmore-<?php echo esc_attr($rand); ?>" data-filter="et-filter-<?php echo esc_attr($rand); ?>" <?php if ($portfolio_layout == 'masonry') { ?>data-layoutmode="packery" <?php } ?>>
  <?php } else { ?>
